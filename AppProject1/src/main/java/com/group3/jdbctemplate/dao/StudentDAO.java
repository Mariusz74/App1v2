...
public interface StudentDAO {
	...
	public int createStudent(String firstname, String lastname);
	...
	public int updateStudent(Integer id, String firstname, String surname, String login, String password, String email, String address);
